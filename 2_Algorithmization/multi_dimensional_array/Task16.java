/*
Магическим квадратом порядка n называется квадратная матрица размером n x n, составленная из
чисел 1, 2, 3, ... , n^2 так, что суммы чисел по каждому столбцу, каждой строке и каждой из
